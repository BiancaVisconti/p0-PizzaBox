    ...
    public partial class migration1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, "thin crust, tomato sauce, vegan cheese, pineapple, green pepper, onions", "SMALL HAWAIIAN PIZZA", 1, 5.00m },
                    { 2L, "thin crust, tomato sauce, vegan cheese, pineapple, green pepper, onions", "MEDIUM HAWAIIAN PIZZA", 2, 9.50m },
                    { 3L, "thin crust, tomato sauce, vegan cheese, pineapple, green pepper, onions", "LARGE HAWAIIAN PIZZA", 3, 13.90m },
                    { 4L, "flatbread, tomato sauce, vegan cheese, tomatos, avocado, tofu, onions", "SMALL EXQUISITE PIZZA", 4, 6.00m },
                    { 5L, "flatbread, tomato sauce, vegan cheese, tomatos, avocado, tofu, onions", "MEDIUM EXQUISITE PIZZA", 5, 11.00m },
                    { 6L, "flatbread, tomato sauce, vegan cheese, tomatos, avocado, tofu, onions", "LARGE EXQUISITE PIZZA", 6, 15.50m },
                    ...
                    { 10L, "thick crust, tomato sauce, tomate, pineapple, avocado", "GIANT SUPER PIZZA", 10, 59.90m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4L, "Abram 34", "TuPizza", 4, "pizza" },
                    { 3L, "Mesquite 476", "MiPizza", 3, "pizza" },
                    { 2L, "Mitchel 83", "DiegoPizza", 2, "diego" },
                    { 1L, "Cooper 786", "PizzaEater", 1, "eater" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 9L, new DateTime(2020, 3, 10, 16, 0, 0, 0, DateTimeKind.Unspecified), 3L, 8L },
